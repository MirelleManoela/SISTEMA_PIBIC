...
const FormSubmissoesModalidadeAlu: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-dimgray font-inter">
      ...
      <div className="absolute top-[calc(50%_-_105px)] left-[calc(50%_-_262px)] rounded-8xs bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border w-[518px] h-[55px] border-[1px] border-solid border-gainsboro-200" />
      ...
      <div className="absolute top-[791px] left-[601px] flex flex-col items-start justify-start p-2.5">
        <div className="relative rounded-8xs bg-darkgoldenrod shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[174px] h-[47px]" />
      </div>
      ...
      <img
        className="absolute top-[424.69px] left-[930.69px] w-[23.62px] h-[23.62px] object-cover"
        alt=""
        src="/image-1@2x.png"
      />
      <div className="absolute top-[calc(50%_+_83px)] left-[calc(50%_-_262px)] rounded-8xs bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border w-[524px] h-[55px] border-[1px] border-solid border-gainsboro-200" />
      ...
      <div className="absolute top-[calc(50%_+_7px)] left-[calc(50%_-_262px)] rounded-8xs bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border w-[524px] h-[55px] border-[1px] border-solid border-gainsboro-200" />
      <div className="absolute top-[calc(50%_+_25px)] left-[calc(50%_-_159px)] font-medium inline-block w-[236px] h-[19px]">
        Área Temática
      </div>
      <div className="absolute top-[calc(50%_-_35px)] left-[calc(50%_-_259px)] font-medium inline-block w-[354px] h-[19px]">
      ...
      <img
        className="absolute top-[535px] left-[938px] w-[23px] h-[23px] object-cover"
        alt=""
        src="/image-2@2x.png"
      />
      ...
      <div className="absolute top-[464px] left-[457px] bg-gainsboro-100 w-[523px] h-11" />
      <div className="absolute top-[502px] left-[458px] bg-cornflowerblue w-[523px] h-11" />
      <div className="absolute top-[546px] left-[458px] bg-gainsboro-100 w-[523px] h-11" />
      <div className="absolute top-[472px] left-[557px] font-medium text-black">
        Artigo
      </div>
      <div className="absolute top-[461px] left-[459px] box-border w-[522.05px] h-0.5 border-t-[2px] border-solid border-dimgray" />
      <div className="absolute top-[503px] left-[457px] box-border w-[522.05px] h-0.5 border-t-[2px] border-solid border-dimgray" />
      <div className="absolute top-[546px] left-[461px] box-border w-[522.05px] h-0.5 border-t-[2px] border-solid border-dimgray" />
      <div className="absolute top-[513px] left-[557px] font-medium text-black">
        Resumo
      </div>
      <div className="absolute top-[552px] left-[557px] font-medium text-black">
        Pesquisa Científica
      </div>
    </div>
  );
...
export default FormSubmissoesModalidadeAlu;
