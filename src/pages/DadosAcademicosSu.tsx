...
const InfoAutorDadosAcademicosSu: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-white font-inter">
      ...
      <img
        ...
        src="/unicap-2@2x.png"
      />
      <div className="absolute top-[90px] left-[1268px] font-semibold inline-block w-[87px] h-[26px]">
        Aluno
      </div>
      <img
        className="absolute top-[83px] left-[1333px] w-[22px] h-[33px] object-cover"
        alt=""
        src="/sort-down@2x.png"
      />
      <div className="absolute top-[68px] left-[1189px] rounded-[50%] bg-gainsboro w-[66px] h-16" />
      <div className="absolute top-[89px] left-[1209px] text-[18px] font-semibold text-black inline-block w-[33px] h-7">
        AL
      </div>
      ...
      <div className="absolute top-[calc(50%_+_251px)] left-[calc(50%_-_128px)] rounded-8xs bg-darkgoldenrod shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[185px] h-[55px]" />
      ...
      />
      <div className="absolute top-[220px] left-[953px] bg-lightgreen w-[428px] h-[65px]" />
      <img
        className="absolute top-[278px] left-[953px] w-[428.02px] h-[7px]"
        alt=""
        src="/line-26.svg"
      />
      <div className="absolute top-[239px] left-[967px] text-black">
        Informações do autor Salvas com sucesso!
      </div>
    </div>
  );
};

export default InfoAutorDadosAcademicosSu;
