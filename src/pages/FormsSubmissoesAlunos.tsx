...
const FormSubmissoesAluno: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-dimgray font-inter">
      ...
      <div className="absolute top-[943px] left-[593px] rounded-10xs bg-darkgoldenrod w-[100px] h-11" />
      <div className="absolute top-[944px] left-[723px] rounded-10xs bg-darkgoldenrod w-[123px] h-11" />
      <b
        className="absolute top-[957px] left-[622px] text-sm text-white cursor-pointer"
...
export default FormSubmissoesAluno;
