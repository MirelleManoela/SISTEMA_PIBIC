...
const InfoAutorDadosPessoaisSuce: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-white font-inter">
      ...
      <div className="absolute top-[calc(50%_+_251px)] left-[calc(50%_-_113px)] rounded-8xs bg-darkgoldenrod shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[185px] h-[55px]" />
      ...
      <div className="absolute top-[226px] left-[940px] bg-lightgreen w-[428px] h-[65px]" />
      <img
        className="absolute top-[284px] left-[940px] w-[428.02px] h-[7px]"
        alt=""
        src="/line-25.svg"
      />
      <div className="absolute top-[248px] left-[954px] text-black">
...
export default InfoAutorDadosPessoaisSuce;
