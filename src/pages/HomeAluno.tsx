...
const HomeAluno: FunctionComponent = () => {
  const onSortDownIconClick = useCallback(() => {
    // Please sync "Home_sair_aluno" to the project
  }, []);
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-black font-inter">
      ...
      <img
        className="absolute top-[91px] left-[1334px] w-[22px] h-[33px] object-cover cursor-pointer"
        alt=""
