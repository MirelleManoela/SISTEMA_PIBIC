...
const FormSubmissoesSalvoAluno: FunctionComponent = () => {
  const onRectangle3Click = useCallback(() => {
    // Please sync "Submissoes_aluno" to the project
  }, []);

  const onRectangle4Click = useCallback(() => {
    // Please sync "form_submetido_aluno" to the project
  }, []);
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-dimgray font-inter">
      ...
      />
      <div
        className="absolute top-[944px] left-[723px] rounded-10xs bg-darkgoldenrod w-[123px] h-11 cursor-pointer"
      ...
      <div className="absolute top-[calc(50%_+_289px)] left-[calc(50%_-_109px)] rounded-8xs bg-darkgoldenrod shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[174px] h-[47px]" />
      ...
      <div className="absolute top-[216px] left-[846px] bg-lightgreen w-[507px] h-[68px]" />
      <img
        className="absolute top-[276.91px] left-[846px] w-[507.03px] h-[7.09px]"
        alt=""
        src="/line-26.svg"
      />
      <div className="absolute top-[237px] left-[878px] text-black">
        Informações da submissão salva com sucesso!
      </div>
    </div>
  );
};

export default FormSubmissoesSalvoAluno;
